...
def get_deadletters_cnt(servicebus_mgmt_client):
    ...
    for topic_properties in servicebus_mgmt_client.list_topics():
        ...
        for sub in subs:
            ...
            if (prop.dead_letter_message_count > 0): # or topic_properties.size_in_bytes > 314572800):
                ...
                #     )
                result[topic_properties.name] = {
                    #'Size': topic_properties.size_in_bytes/1024/1024,
                    'Subscription': sub.name
                    ,'dead_letters_count': prop.dead_letter_message_count}
    return result
